...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <form action="{{ route('admin.metatags.store') }}" method="POST">
                @csrf
                <div class="col-xl-12">
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'active show' : '' }}" id="{{ $key }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('home_desc' . $key) }}" class="form-control"
