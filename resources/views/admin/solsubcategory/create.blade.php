...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Həllər Alt Kategoriyası /</span> Yarat</h4>
        <div class="row">
            <form action="{{ route('admin.solsubcategory.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-xl-12">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="link"
                                            id="link" value="{{ old('link') }}" placeholder="Link Daxil Edin">
                                    </div>
                                    <br>
                                    <div class="form-group">
