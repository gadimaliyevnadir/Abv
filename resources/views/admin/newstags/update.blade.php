...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Xəbər Teqi /</span> Düzənləmə</h4>

        <div class="row">
            <form action="{{ route('admin.newstags.update',$newstag->id) }}" method="POST">
                @csrf
                 @method("PUT")
                <div class="col-xl-12">
                    <h5 class="text-muted">Xəbər Teqi</h5>
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'active show' : '' }}" id="{{ $key }}"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('name' . $key, $newstag->getTranslation('name', $key)) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('slug' . $key, $newstag->getTranslation('slug', $key)) }}"
