...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Komanda Üzvü/</span> Yarat</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="title[{{ $key }}]" id="title"
                                                value="{{ old('title'. $key) }}" placeholder="Adını Yazın">
                                        </div>
                                        <div class="form-group">
                                            <label class="mb-1" for="desc">Mündəricat</label>
                                            <textarea placeholder="Enter Description" id="editor" name="desc[{{ $key }}]" class="mt-3 mb-3">{{ old('desc' . $key) }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="mb-1" for="subtitle">Vəzifəsi</label>
                                            <input class="form-control" type="text" name="subtitle[{{ $key }}]"
                                                id="subtitle" value="{{ old('subtitle' . $key) }}"
