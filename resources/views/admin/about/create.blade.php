                ...
                <div class="col-xl-12">
                    ...
                    <div class="nav-align-top mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="title[{{ $key }}]"
                                                id="title" value="{{ old('title' . $key) }}"
                                                placeholder="Başlıqı Daxil Edin">
                                        </div>
                                        <div class="form-group">
                                            <label class="mb-1" for="desc">Mündəricat</label>
                                            <textarea placeholder="Mündəricat Daxil Edin" id="editor" name="desc[{{ $key }}]" class="mt-3 mb-3 form-control">{{ old('desc' . $key) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="form-group" style="background-color: white">
                            <label for="exampleInputFile">Şəkil 1</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" value="{{ old('image1') }}" name="image1"
                         ...
                         <div class="form-group" style="background-color: white">
                            <label for="exampleInputFile">Şəkil 2</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" value="{{ old('image2') }}" name="image2"
                                        class="custom-file-input" id="exampleInputFile">
                                    <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                                </div>
                            </div>
                         ...
                         <div class="form-group" style="background-color: white">
                            <label for="exampleInputFile">Şəkil 3</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" value="{{ old('image3') }}" name="image3"
                                        class="custom-file-input" id="exampleInputFile">
                                    <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                                </div>
                            </div>
