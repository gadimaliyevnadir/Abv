...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <form action="{{ route('admin.socialicons.update',$socialicon->id) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="tab-content">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('class',$socialicon->class) }}" class="form-control" name="class"
                                        id="class" placeholder="Enter Class Name">
                                </div>
                                <div class="form-group">
                                    <label for="links">Link</label>
                                    <input type="text" value="{{ old('links',$socialicon->links) }}" class="form-control" name="links"
