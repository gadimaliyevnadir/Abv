...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Mağazalarımız /</span> Yarat</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="address[{{ $key }}]"
                                                id="address" value="{{ old('address' . $key) }}"
                    ...
                    <div class="card-body" style="background-color: white">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="Xəritə Linki Daxil edin" id="maplink" name="maplink" class="mt-3 mb-3 form-control">{{ old('maplink') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
